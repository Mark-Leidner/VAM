c!#   $Id: hdf.h,v 1.1 1997/02/21 23:45:35 leidner Exp $
c!#   $Log: hdf.h,v $
...
C****************************************************************************
C
C  Id: hdf.h,v 1.15 1996/06/29 01:07:52 acheng Exp
C
C *-----------------------------------------------------------------------------
C * File: 	hdf.h
...
c	tags and refs
     ...
     *		DFTAG_LINKED, DFTAG_VERSION, DFTAG_COMPRESSED
...
c	Scientific Data set 
     ...
     *		DFTAG_BREQ,DFTAG_EREQ,DFTAG_CAL, DFTAG_FV
