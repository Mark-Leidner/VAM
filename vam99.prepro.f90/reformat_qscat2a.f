c
c!# CSU IDENTIFICATION : reformat_qscat2a
c!#     $Id: reformat_qscat2a.f,v 1.6 2004/03/19 20:47:33 rnh Exp $
...
c!# CHANGE LOG : 
c!#	$Log: reformat_qscat2a.f,v $
c!#	Revision 1.6  2004/03/19 20:47:33  rnh
c!#	FGAT: u_fgat=vfgat=0, alpha=1.  Still TBD: are times useful
c!#	
c!#	Revision 1.5  2001/09/18 17:53:46  mcc
c!#	Added code for latitude and longitude controlled data window.
c!#	Parameters are read from namelist.
c!#	
c!#	Revision 1.4  2001/08/07 17:12:56  mcc
c!#	Replaced lname=15 with lname=10 to compile with changes made
c!#	to obsio.f for f90 compilation.
c!#	
c!#	Revision 1.3  2001/01/04 19:20:09  mcc
c!#	Changed parecl from 4 to 1 for SGI.
c!#	
c!#	Revision 1.2  2000/10/23 19:01:06  mcc
c!#	Removed subroutine maxmin. This was used for testing in the past.
c!#	
c!#	Revision 1.1  2000/03/28 17:52:23  mcc
c!#	Initial revision
c!#	
...
c     Define Variables
      ...
      character*132 l2a_file, fname1, hdr_fname, bin_fname

      namelist /qsfn/ l2a_file, hdr_fname, bin_fname, 
     & satid_const, modfn_const, kpm2_const, xmin, xmax, ymin, ymax

c!# LOCAL DATA STRUCTURES : None

c!# DATA FILES : QuikScat Level 2A (hdf format) only
